...
namespace LOLItems
{
    public class Manamune : PassiveItem
    {
        ...
        public static void Init()
        {
            ...
            string resourceName = "LOLItems/Resources/passive_item_sprites/manamune_item_sprite";
            string upgradeResourceName = "LOLItems/Resources/passive_item_sprites/muramana_item_sprite";
